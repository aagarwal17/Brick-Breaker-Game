 ...
 *
 */
public class MapPanel3 extends JPanel implements KeyListener
{
	//Fields
	...
	public void initialize()
	{
		mousex = 0;
		theBall = new Ball();
		theBall.setBallSize(5);
		thePaddle = new Paddle(40,10);
		theMap = new Map(10, 16);
		theScore = new Score();
